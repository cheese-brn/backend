...
public class StrainSearchController {
    ...
    /**
     * Обработчик запроса на поиск всех неудаленных штаммов. Формируем JSON и отправляем его
     *
    ...
    /**
     * Обработчик запроса на поиск всех удаленных штаммов. Формируем JSON и отправляем его
     *
     * @return список штаммов
     */
    ...
    /**
     * Обработчик запроса на поиск штамма по ID. Формируем JSON и отправляем клиенту
     *
     * @param id ID штамма
     * @return JSON штамма
     */
    ...
    /**
     * Обработчик запроса на поиск штаммов по заданному ID вида и формирования JSON
     *
     * @param id ID вида
    ...
    /**
     * Обработчик запроса на поиск штаммов по заданному ID рода и формирования JSON
     *
     * @param id ID рода
     * @return JSON списка штаммов
     */
    ...
    /**
     * Обработчик запроса на поиск штаммов по содержанию строки в их имени
     *
